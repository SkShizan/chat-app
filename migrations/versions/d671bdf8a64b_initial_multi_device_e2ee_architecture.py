"""Initial multi-device E2EE architecture

Revision ID: d671bdf8a64b
Revises: 
Create Date: 2025-11-05 09:55:55.907239
...
def upgrade():
    ...
    op.create_table('encrypted_message_recipient',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('message_id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['message_id'], ['chat_message.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('message_id', 'device_id', name='_msg_device_uc')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('encrypted_message_recipient')
